...
*Defined in [src/methods/democracy/deactivateProxy.ts:13](https://github.com/paritytech/txwrapper/blob/9a03411/src/methods/democracy/deactivateProxy.ts#L13)*
