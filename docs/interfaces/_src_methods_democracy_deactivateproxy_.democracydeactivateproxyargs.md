...
*Defined in [src/methods/democracy/deactivateProxy.ts:13](https://github.com/paritytech/txwrapper/blob/96fc986/src/methods/democracy/deactivateProxy.ts#L13)*
