...
*Defined in [src/methods/democracy/deactivateProxy.ts:13](https://github.com/paritytech/txwrapper/blob/840775d/src/methods/democracy/deactivateProxy.ts#L13)*
