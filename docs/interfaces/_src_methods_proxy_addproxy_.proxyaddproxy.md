...
*Defined in [src/methods/proxy/addProxy.ts:13](https://github.com/paritytech/txwrapper/blob/ccdcd52/src/methods/proxy/addProxy.ts#L13)*
...
*Defined in [src/methods/proxy/addProxy.ts:23](https://github.com/paritytech/txwrapper/blob/ccdcd52/src/methods/proxy/addProxy.ts#L23)*
