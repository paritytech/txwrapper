...
*Defined in [src/methods/session/setKeys.ts:13](https://github.com/paritytech/txwrapper/blob/ef571f4/src/methods/session/setKeys.ts#L13)*
...
*Defined in [src/methods/session/setKeys.ts:17](https://github.com/paritytech/txwrapper/blob/ef571f4/src/methods/session/setKeys.ts#L17)*
