...
*Defined in [src/methods/session/setKeys.ts:13](https://github.com/paritytech/txwrapper/blob/7cf4bc5/src/methods/session/setKeys.ts#L13)*
...
*Defined in [src/methods/session/setKeys.ts:17](https://github.com/paritytech/txwrapper/blob/7cf4bc5/src/methods/session/setKeys.ts#L17)*
