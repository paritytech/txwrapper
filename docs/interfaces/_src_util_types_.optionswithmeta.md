...
*Defined in [src/util/types.ts:94](https://github.com/paritytech/txwrapper/blob/96fc986/src/util/types.ts#L94)*
...
*Defined in [src/util/types.ts:83](https://github.com/paritytech/txwrapper/blob/96fc986/src/util/types.ts#L83)*
