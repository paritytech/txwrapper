[@amaurymartiny/txwrapper](../README.md) › [Globals](../globals.md) › ["methods/staking/nominate"](_methods_staking_nominate_.md)
...
*Defined in [src/methods/staking/nominate.ts:23](https://github.com/amaurymartiny/polkadotjs-wrapper/blob/8d67f3d/src/methods/staking/nominate.ts#L23)*
