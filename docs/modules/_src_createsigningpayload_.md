...
> [Globals](../globals.md) / "src/createSigningPayload"
...
*Defined in [src/createSigningPayload.ts:45](https://github.com/paritytech/txwrapper/blob/968ccb6/src/createSigningPayload.ts#L45)*
