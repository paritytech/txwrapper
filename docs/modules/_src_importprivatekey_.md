...
*Defined in [src/importPrivateKey.ts:10](https://github.com/paritytech/txwrapper/blob/9a03411/src/importPrivateKey.ts#L10)*
...
*Defined in [src/importPrivateKey.ts:18](https://github.com/paritytech/txwrapper/blob/9a03411/src/importPrivateKey.ts#L18)*
