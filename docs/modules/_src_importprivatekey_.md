...
*Defined in [src/importPrivateKey.ts:10](https://github.com/paritytech/txwrapper/blob/fc81d5b/src/importPrivateKey.ts#L10)*
...
*Defined in [src/importPrivateKey.ts:18](https://github.com/paritytech/txwrapper/blob/fc81d5b/src/importPrivateKey.ts#L18)*
