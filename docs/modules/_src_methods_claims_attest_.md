[@substrate/txwrapper](../README.md) › [Globals](../globals.md) › ["src/methods/claims/attest"](_src_methods_claims_attest_.md)
...
*Defined in [src/methods/claims/attest.ts:24](https://github.com/paritytech/txwrapper/blob/1ac58f6/src/methods/claims/attest.ts#L24)*
