...
*Defined in [src/methods/democracy/types.ts:26](https://github.com/paritytech/txwrapper/blob/2a7ffc5/src/methods/democracy/types.ts#L26)*
...
*Defined in [src/methods/democracy/types.ts:7](https://github.com/paritytech/txwrapper/blob/2a7ffc5/src/methods/democracy/types.ts#L7)*
