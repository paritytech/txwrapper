[@substrate/txwrapper](../README.md) › [Globals](../globals.md) › ["src/methods/poll/vote"](_src_methods_poll_vote_.md)
...
*Defined in [src/methods/poll/vote.ts:23](https://github.com/paritytech/txwrapper/blob/6ef1ba4/src/methods/poll/vote.ts#L23)*
