...
*Defined in [src/util/claims.ts:61](https://github.com/paritytech/txwrapper/blob/1ac58f6/src/util/claims.ts#L61)*
...
*Defined in [src/util/claims.ts:32](https://github.com/paritytech/txwrapper/blob/1ac58f6/src/util/claims.ts#L32)*
