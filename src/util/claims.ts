...
export function getPolkadotStatement(
  ...
  return statementKind.toString() === 'Regular'
    ...
    : {
        ...
        sentence:
          'I hereby agree to the terms of the statement whose SHA-256 multihash is Qmawwbu1KeZ46peRspbsTUot8Lq6KcHutuiUKJ142N4Reg. (This may be found at the URL: https://statement.polkadot.network/saft.html)',
